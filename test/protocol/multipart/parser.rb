...
describe Protocol::Multipart::Parser do
	...
	it "allows a boundary after the maximum preamble size" do
		data = "x\r\n--#{boundary}\r\n\r\n--#{boundary}--\r\n"
		parser = Protocol::Multipart::Parser.new(StringIO.new(data), boundary, preamble_size_limit: 3)
	...
	it "allows the header terminator after the maximum header size" do
		data = "--#{boundary}\r\nX: y\r\n\r\nvalue\r\n--#{boundary}--\r\n"
		parser = Protocol::Multipart::Parser.new(StringIO.new(data), boundary, header_size_limit: 6)
	...
	it "allows limits to be disabled" do
		data = "preamble\r\n--#{boundary}\r\nContent-Type: text/plain\r\n\r\nvalue\r\n--#{boundary}--\r\n"
		parser = Protocol::Multipart::Parser.new(StringIO.new(data), boundary, preamble_size_limit: nil, header_size_limit: nil, header_count_limit: nil, part_count_limit: nil)
	...
	it "rejects negative limits" do
		expect do
			Protocol::Multipart::Parser.new(StringIO.new, boundary, part_count_limit: -1)
